...
export const CONTENT_PT: PortfolioContent = {
  ...
  accessibility: {
    ...
    languageSwitcherVisibleLabel: 'Idioma:',
    portugueseLanguageLabel: 'Alterar idioma para português do Brasil',
    portugueseLanguageShortLabel: 'Português BR',
    englishLanguageLabel: 'Alterar idioma para inglês dos Estados Unidos',
    englishLanguageShortLabel: 'English US',
    settingsLabel: 'Ajustes',
    settingsButtonLabel: 'Abrir ajustes de acessibilidade e idioma',
    settingsPanelLabel: 'Ajustes de acessibilidade e idioma',
    ...
    heroMetricsLabel: 'Destaques profissionais',
    accessibilityControlsLabel: 'Controles de acessibilidade',
    themeToggleLabel: 'Tema visual',
    enableLightThemeLabel: 'Ativar tema claro',
    enableDarkThemeLabel: 'Ativar tema escuro',
    darkThemeShortLabel: 'Modo escuro',
    lightThemeShortLabel: 'Modo claro',
    ...
    resetFontSizeLabel: 'Restaurar tamanho da fonte',
    resetFontSizeShortLabel: 'Resetar',
  ...
  about: {
    ...
    highlights: [
      ...
      'Agilidade e colaboração técnica',
    ],
  },
  skills: {
    ...
    featuredTechnologies: [
      ...
      { name: 'Kafka', category: 'Mensageria', iconKind: 'kafka' },
      { name: 'Docker', category: 'Containers', iconKind: 'docker' },
      { name: 'Kubernetes', category: 'Orquestração', iconKind: 'kubernetes' },
